...
$inserta_articulo="Insert into articulos(codigo,descripcion,costo,precio,proveedor,linea,grupo,imagen,codigostock,fecha_cad) values(
'$codigo','$descripcion',$costo,$precio,$proveedor,$linea,$grupo,'$nombre_imagen','$codigostock','$fecha_caducidad')";
